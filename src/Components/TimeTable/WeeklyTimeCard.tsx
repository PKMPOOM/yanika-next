...
const WeeklyTimeTableCard = ({
  ...
  return (
    <Link
      ...
      className={`group flex w-full items-center justify-between gap-2 ${subjectNotFound ? "text-rose-500" : "text-slate-800"
        }`}
    >
      <div
        key={todayClass.id}
      ...
      >
        <div className="box-border flex min-h-full flex-1 p-1">
          <div
            className={`relative box-border flex w-full flex-1 flex-col gap-2 overflow-hidden rounded-md border p-2 text-slate-900  hover:shadow-md ${todayClass.accept
          ...
          >
            <div className="flex justify-between">
              <div className="flex w-full gap-2 text-sm">
                ...
                <h1
                  className={`font-semibold transition-all duration-150 ${subjectNotFound
                ...
                <div
                  className={`-translate-x-1 transition-all duration-150 group-hover:translate-x-0 ${subjectNotFound
                    ? "group-hover:text-rose-500"
                    : "group-hover:text-emerald-500"
                    }`}
                >
