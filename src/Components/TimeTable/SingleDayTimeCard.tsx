...
import { Badge, Button, ConfigProvider, Tag } from "antd"
...
const SingleDayTimeTableCard = ({
    ...
    const isPaid = todayClass.bookingHistory?.status === "paid"
                ...
                >
                    ...
                    >
                        ...
                        <DescValue
                            ...
                            keyValue={
                                <Badge
                                    size="small"
                                    count={todayClass.userBooked.length}
                                >
                                    <UserOutlined />
                                </Badge>
                            }
                    ...
                    <div className="flex gap-2 text-sm ">
                        {!subjectNotFound && (
                            ...
                            >
                                <p className="group-hover:text-emerald-500">
                                    Subject Details
                                </p>
                        ...
                        <div className="absolute bottom-2 right-2 flex items-center gap-2">
                            ...
                            <Button
                                ...
                                onClick={() => {
                                    handleScheduleGoogleMeet({
                                        ...
                                        start_time:
                                            todayClass.start_time as Dayjs,
                            ...
                            >
                                {isDayPassed ? (
                                    <>
                                        next{" "}
                                        {dayjs(todayClass.start_time).format(
                                            "dddd on H:mm"
                                        )}
                                    </>
                                ) : (
