    ...
    if (showSelectBar) {
        return (
            <div
                ...
                className={`absolute top-0 z-50 box-border flex h-7 cursor-default justify-between overflow-hidden rounded-lg border-2 border-emerald-300 bg-emerald-50 shadow-md shadow-emerald-500/30`}
            >
                <div className="p-2">
